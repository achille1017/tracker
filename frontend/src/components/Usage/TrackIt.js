...
const TrackIt = (props) => {
    ...
    return (
        <div id='introBox'>
            <h2 className='textUsageMid'> The Importance of Daily Habit Tracking for Productivity and Success </h2>
            ...
            <div className='blocIntro'>
                <h3 className='titleUsage'>1. Increased Awareness</h3>
            ...
            <div className='blocIntro'>
                <h3 className='titleUsage'>2. Accountability</h3>
            ...
            <div className='blocIntro'>
                <h3 className='titleUsage'>3. Motivation and Progress</h3>
            ...
            <div className='blocIntro'>
                <h3 className='titleUsage'>4. Building Resilience</h3>
            ...
            <div className='blocIntro'>
                <h3 className='titleUsage'>5. Enhanced Well-being</h3>
